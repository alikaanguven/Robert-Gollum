...
def comparehists(name,hs,legend,colors=None,scale=False, ratio=False):
  ...
  markers = [i for i in range(20,50)]
  c = ROOT.TCanvas("c"+name,"c"+name,1000,1000)
  ...
  if ratio:
    ...
    leg = c.GetUpperPad().BuildLegend(x1=0.66,y1=0.74,x2=0.90,y2=0.88)
  else:
    c.SetLogy()
    leg = c.BuildLegend(x1=0.66,y1=0.74,x2=0.90,y2=0.88)
